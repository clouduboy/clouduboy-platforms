...
byte board_0[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
byte board_1[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
byte board_2[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
byte board_3[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
byte board_4[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
byte board_5[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
byte board_6[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
byte board_7[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
...
void generate(byte arr[], uint8_t* info_arr) {
////// FUNCTION BODY //////
int block = 0;
int block_num = 3;
...
void draw_row(int y, byte* arr, byte* info_arr) {
////// FUNCTION BODY //////
...
arduboy.drawBitmap( (field_start_x + x * sprite_size), (field_start_y + y * sprite_size), gfx_field[type], GFX_FIELD_WIDTH, GFX_FIELD_HEIGHT, WHITE );
}
